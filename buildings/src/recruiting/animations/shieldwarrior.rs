...
use animations::{AnimationSpriteSheet, SpriteVariants, anim};
use shared::enum_map::*;

use crate::{BuildStatus, HealthIndicator};

const ATLAS_COLUMNS: usize = 11;

pub(crate) fn shieldwarrior_building(
    world: &mut World,
) -> AnimationSpriteSheet<BuildStatus, SpriteVariants> {
    let asset_server = world.resource::<AssetServer>();
    let texture = asset_server.load("sprites/buildings/warrior_house.png");
